...
use Orno\Cache\Adapter\EtcdAdapter;

class EtcdAdapterTest extends \PHPUnit_Framework_Testcase
{
    protected $adapter;
    ...
    public function testGetAndSet()
    {
        ...
        $this->assertInstanceOf('Orno\Cache\Adapter\EtcdAdapter', $this->adapter->delete($key));
    }
    ...
    {
        $this->assertInstanceOf('Orno\Cache\Adapter\EtcdAdapter', $this->adapter->setConfig([]));
    }
